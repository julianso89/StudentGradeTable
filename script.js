...
function addClickHandlersToElements(){
    $(".btn.btn-primary").click(handleAddClicked);
...
function renderStudentOnDom(studentObj){
    ...
    tableRow.append(studentName, course, studentGrade, deleteButton);
...
function updateStudentList(studentArray){
      ...
      var studentAverage = calculateGradeAverage(studentArray);
      renderGradeAverage(studentAverage);
}
/***************************************************************************************************
